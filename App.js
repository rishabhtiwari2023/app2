...
logo.addEventListener("click", () => {
 ...
 <div className="header">
  ...
  <div className="header-menu">
   <a href="https:/r.com" className="active">Find Job</a>
   <a href="https:/r.com">Company Review</a>
   <a href="https:/r.com">Find Salaries</a>
  </div>
      ...
      <div className="job-overview-card">
       <div className="job-card overview-card">
        ...
        <path d="M512 92L383.7 0 256 91.5v1l127.7 91.6zm0 0M512 276.4l-128.3-92L256 275.9v1l127.7 91.5zm0 0M256 486.1l128.4-92-128.3-92zm0 0" fill="#feb0a5" />
         ...
         <svg className="heart feather feather-heart" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" >
